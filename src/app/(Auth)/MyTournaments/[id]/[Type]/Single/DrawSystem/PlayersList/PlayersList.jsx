...
import { AddKnockoutWatingUser } from "@/Toolkit/Slices/TournamentsSlice";

function PlayersList() {
  const WatingListResult = useRef();
  const Dispatch = useDispatch();
  const TournamentsPlayersList = useSelector(
    (State) => State.Tournaments.KnockoutWating
  );
  console.log("TournamentsPlayersList", TournamentsPlayersList);
    ...
    <div className="PlayersList">
      <div className="left">
        ...
        <div className="waiting-body">
          {TournamentsPlayersList.length > 0 ? (
            <>
              {TournamentsPlayersList.map((user, index) => (
